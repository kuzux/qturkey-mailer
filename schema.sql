...
create table jobs(id integer primary key, status text not null, scheduled_to text not null, started_at text, finished_at text, template_id integer not null references templates(id), address_start_index integer not null);
